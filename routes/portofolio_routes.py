...
from controllers.PortofolioController import get_portofolio,get_portofolio_detail,get_portofolio_list,get_portofolio_image
...
portofolio_bp.route('/images',methods=['GET'])(get_portofolio_image)